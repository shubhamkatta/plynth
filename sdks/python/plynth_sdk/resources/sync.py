...
class AdminComponentsResource(_Base):
    ...
    def list(self, slug: str) -> List[ComponentResponse]:
        return self._c.request(
            RequestSpec("GET", f"/api/v1/admin/products/{slug}/components",
                        as_platform_admin=True)
        )

    def create(self, slug: str, req: ComponentCreateRequest) -> ComponentResponse:
        return self._c.request(
    ...
    def update(self, slug: str, code: str, req: ComponentUpdateRequest) -> ComponentResponse:
        return self._c.request(
...
class ComponentsResource(_Base):
    ...
    def list(self) -> List[UserComponentStatus]:
        return self._c.request(RequestSpec("GET", "/api/v1/components"))

    def list_for_user(self, user_id: str) -> List[UserComponentStatus]:
        return self._c.request(
    ...
    def clear_override(self, user_id: str, code: str) -> None:
        self._c.request(
